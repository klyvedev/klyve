...
2.  **Review:** Every block of code passes through automated syntax and style reviews before being committed.
3.  **Context:** It locally retains the context of existing architectural patterns to ensure consistency.
...
1.  **Immediate Fix:** Pause, debug manually in your IDE, and retry the test.
2.  **Acknowledge & Deferred Fix:** Ship the sprint as "Completed," but Klyve will automatically log a high-priority **Bug Report** in the backlog for the regression failure.
